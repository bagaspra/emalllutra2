...
<div class="ps-page--product">
    ...
    <h1><?php echo $record['nama_produk']; ?></h1>
        <div class='sub_title'>
            ...
            <p>Berat : <a href="#"><?php echo ($record['berat']>1000?number_format($record['berat']/1000,1).' Kg':$record['berat'].' Gram') ?></a></p>
                        ...
                        <div class="ps-product__shopping d-none d-sm-block" style='margin-bottom:0rem; padding-bottom:10px'>
                            ...
                            <?php 
                                if (stok($record['id_reseller'],$record['id_produk'])<=0){ 
                                    echo "<a style='color:#a7a7a7; background-color:#e2e2e2; margin-right:0px' class='ps-btn ps-btn--black add-to-cart-empty'>+ Keranjang</a>";
                                }else{
                                    echo "<a style='color:#fff; margin-right:0px' id='$record[id_produk]' class='ps-btn ps-btn--black add-to-cart'>+ Keranjang</a>";
                                }
                            ?>
