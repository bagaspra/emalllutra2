        ...
        <div class="navigation__right">
            <div class="header__actions">
                ...
                <div class="ps-block--user-header">
                    ...
                    <?php }else{ ?>
                        <div class="ps-block__left">
                            <a href='<?php echo base_url(); ?>auth/login'><i class="icon-enter"></i></a>
                        </div>
                        <div class="ps-block__right">
    ...
    <div class="navigation__content">
        ...
        <?php 
            if ($this->session->id_konsumen!=''){
                ...
                echo "<a class='navigation__item ps-toggle--sidebar' href='#' data-toggle='modal' data-target='.bd-example-modal-lg'><i class='icon-user'></i><span> Login</span></a>";
            }
        ?>
    </div>
</div>
                ...
                if ($parent=='0'){
                    if ($ci->session->level=='konsumen'){ 
                        if (reseller($ci->session->id_konsumen)!=''){
                            ...
                            $html .= "<li class='menu-item-has-children'><a href='#'> Menu Toko <span class='badge badge-secondary' style='font-size:85%; background-color: #cecece; color:#000'>".(total_penjualan('0', reseller($ci->session->id_konsumen))+$komplain_toko)."</span></a> <span class='sub-toggle'></span>
                                    <ul class='sub-menu'>
                                        ...
                                        <li class='current-menu-item'><a href='".base_url()."members/pembelian'> Komplain <span class='badge badge-secondary' style='font-size:85%; background-color: #cecece; color:#000'>$komplain_toko</span></a></li>
                                        <li class='current-menu-item'><a href='".base_url()."members/penjualan'> Orders Masuk <span class='badge badge-secondary' style='font-size:85%; background-color: #cecece; color:#000'>".total_penjualan('0', reseller($ci->session->id_konsumen))."</span></a></li>
                                        <li class='current-menu-item'><a href='".base_url()."members/upgrade'> <span class='blink_me'>Upgrade Toko</span></a></li>
                                    </ul>
                            </li>";
                        }else{
