...
<div id="homepage-1">
    <div class="ps-home-banner ps-home-banner--1">
        <div class="ps-container container1" style='margin-top:30px'>
            <div class="ps-section__left" style='padding-right:10px;'>
    ...
    <div class="ps-container">
        <center>
            ...
            <div class="ps-carousel--nav owl-slider" data-owl-auto="false" data-owl-loop="false" data-owl-speed="10000" data-owl-gap="30" data-owl-nav="true" data-owl-dots="true" data-owl-item="11" data-owl-item-xs="5" data-owl-item-sm="3" data-owl-item-md="4" data-owl-item-lg="5" data-owl-item-xl="6" data-owl-duration="1000" data-owl-mousedrag="on">
        <?php    
            $i = 1;
            $x=1;
                    ...
                    if ($x%2==0){ echo "<div class='ps-product ps-product--inner' style='margin-bottom:0px'>"; $x++; }
                        echo "<div class='col4'>
                            <a style='margin-top:15px; height:80%' class='ps-block__overlay' href='".base_url()."produk/kategori/$row[kategori_seo]'>
                                $icon <p style='font-size:14px; line-height:1.1em; color:#000; height:30px; overflow:hidden;'>$row[nama_kategori]</p>
                            </a>
                            </div>";
                    if ($i%2==0){ echo "</div>"; $x++; }
