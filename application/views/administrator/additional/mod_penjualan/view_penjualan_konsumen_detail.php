                ...
                <?php echo "<div class='col-sm-$kolom col-xs-12'>  "; ?>
                  ...
                  <tbody>
                    ...
                    if ($rows['keterangan']!=''){
                      ...
                      echo "<tr><td><strong>$judul</strong></td> <td><b>".$exal[5]."</b> (".substr($exal[6], 0, -2)."xx)</td></tr>";
                    }else{
                      echo "<tr><td><strong>$judul</strong></td> <td><b>$rows[nama_lengkap]</b> (".substr($rows['no_hp'], 0, -2)."xx)<br>";
                    }
                    ?>
